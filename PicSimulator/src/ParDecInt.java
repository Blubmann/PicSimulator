...
public class ParDecInt extends Thread{
	...
	/**ParDecInt bekommt ein Array �bergeben, indem der die relevanten Quellcodezeilen als String gespechert sind.
	...
	/**Die Methode bekommt beim Dr�cken der Starttaste den extrahierten Opcode �bergeben und 
	 * pr�ft mithilfe der der Integerzahl welcher Befehl vorliegt.
	 */
